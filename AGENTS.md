...
- 当前分支版本 **v2.0.0**，代号 `STEINS;GATE`（命运石之门，大版本以动漫代号命名仿 Vue 传统，谱系见 `README.md`）——v2.0 Phase 1「博弈机制」（签收制、链式审计日志、统计三件套、昨日天气、结转原因、徽章，见 `docs/doing/v2.0-博弈机制落地计划.md`）已开发完毕待发版；最新已发布产物 v1.2.0（v1.x 代号 `niulai`）。
